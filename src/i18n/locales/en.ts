...
const en: MarketingDictionary = {
  ...
  hero: {
    badge: "Pre-launch: Limited beta spots available",
    title: "Your Personal Brand,",
    titleHighlight: "Strategized by AI",
    subtitle:
      "You\u2019re an expert. Your knowledge is valuable. But are the right people listening?",
    description:
      "Kun helps MENA professionals turn their expertise into authority. Get a complete personal brand strategy in minutes, not months.",
    ctaPrimary: "Join Waitlist",
    ctaSecondary: "See How It Works",
    tagline:
      "\u0643\u064F\u0646 \u2014 Arabic for \u201CBe\u201D \u2014 a reminder that your voice matters",
  },
  problem: {
    title: "You Have the Knowledge.",
    titleHighlight: "The World Just Doesn\u2019t Know Yet.",
    subtitle:
      "You\u2019re not alone. Most professionals in the MENA region are invisible online, despite being experts in their field.",
    stats: [
      {
        stat: "92%",
        label: "of professionals lack a clear personal brand strategy",
      },
      {
        stat: "87%",
        label: "don\u2019t know where to start with content creation",
      },
      {
        stat: "73%",
        label: "feel their expertise is undervalued in their industry",
      },
    ],
  },
  features: {
    ...
    steps: [
      {
        ...
        description:
          "We discover your unique value proposition \u2014 what makes you different, and where your expertise shines brightest.",
        details: [
      ...
      },
      {
        ...
        description:
          "We unlock your brand story, positioning, and a complete personalized strategy based on best practices.",
        details: [
          "Custom positioning statement",
      ...
      },
      {
        ...
        description:
          "We unleash your brand into the world with ready-made content, a clear plan, and a strategy you can trust.",
        details: [
          "Day-by-day posting calendar",
          "Pre-written content pieces",
  ...
  pricing: {
    ...
    savingsTemplate: "Save ${{amount}}/month with yearly",
    free: "Free",
    perMonth: "/month",
    perYear: "/year",
    ...
    plans: [
      {
        ...
        features: [
          ...
          "1 content pillar recommendation",
